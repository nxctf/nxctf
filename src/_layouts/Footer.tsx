...
import { Code2, Coffee, GitBranch, Shield } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-8">
          ...
          <div className="flex items-center justify-center md:justify-end gap-3">
            ...
            <a
              ...
              target="_blank"
              className={`group flex items-center gap-3 py-3 pl-3 pr-4 ${'bg-card border border-border rounded-xl'} hover:border-blue-500/40`}
              title="Organization"
            >
